...
{    
		#if (M10DEBUG)
	printf_string("prf_pack_char_pres_fmt\n\r");
		#endif
...
{
		#if (M10DEBUG)
    printf_string("prf_unpack_char_pres_fmt\n\r");
		#endif	
...
{ 
		#if (M10DEBUG)
  printf_string("prf_read_char_send\n\r");
		#endif		
...
{ 
		#if (M10DEBUG) 
	printf_string("prf_register_atthdl2gatt\n\r");
			#endif	
...
{ 
		#if (M10DEBUG)
	printf_string("prf_unregister_atthdl2gatt\n\r");
			#endif		
    if(svc->shdl != ATT_INVALID_HANDLE)
    {
...
{  
		#if (M10DEBUG)
  printf_string("prf_disc_svc_send\n\r");
			#endif			
...
{  
		#if (M10DEBUG)
  printf_string("prf_disc_incl_svc_send\n\r");
			#endif			
...
{  
		#if (M10DEBUG)
	printf_string("prf_disc_char_all_send\n\r");
			#endif		
...
{  
		#if (M10DEBUG)
	printf_string("prf_gatt_write_ntf_ind\n\r");
				#endif	
    uint8_t value[2];
...
{ 
		#if (M10DEBUG)
  printf_string("prf_check_svc_char_validity\n\r"); 
				#endif	
...
{   
		#if (M10DEBUG)
	printf_string("prf_check_svc_char_desc_validity\n\r"); 
				#endif	
    uint8_t status = PRF_ERR_OK;
    uint8_t i;
...
{
		#if (M10DEBUG)
	printf_string("prf_search_chars\n\r"); 
					#endif	
    //Counters
    uint8_t cursor;
...
{
		#if (M10DEBUG)	
	  printf_string("prf_search_descs\n\r"); 
			#endif		
    //Counters
    uint8_t cursor;
...
{   
		#if (M10DEBUG)
	printf_string("prf_client_disable_ind_send\n\r"); 
					#endif		
...
{
		#if (M10DEBUG)  
	  printf_string("prf_client_pool_envs_alloc\n\r");
					#endif		
    // Allocation status
    uint8_t status = PRF_ERR_OK;
...
{ 
		#if (M10DEBUG)  
  printf_string("prf_client_pool_envs_free\n\r"); 
   #endif	
...
{ 
		#if (M10DEBUG)  
  printf_string("prf_client_env_alloc\n\r");
   #endif		
    // Status
    uint8_t status = PRF_ERR_OK;
...
{  
		#if (M10DEBUG)  
	printf_string("prf_client_env_free\n\r"); 
	   #endif
    // Status
    uint8_t status = PRF_ERR_OK;
...
{   
		#if (M10DEBUG)	
	printf_string("prf_client_enable\n\r"); 
	   #endif
    // Status
    uint8_t status = PRF_ERR_OK;
    // Index
...
{
		#if (M10DEBUG)
	printf_string("prf_client_disable\n\r");
	   #endif	
    // Status
...
{
	#if (M10DEBUG)
  printf_string("prf_client_reset\n\r");
	   #endif		
    // Index
    uint8_t conidx;
...
{ 
 	#if (M10DEBUG)
	printf_string("prf_client_get_env\n\r");
		   #endif	
...
{
	#if (M10DEBUG)  
	printf_string("prf_client_enable_error\n\r");
		   #endif		
...
{   
	#if (M10DEBUG)
	printf_string("prf_client_att_info_rsp\n\r");
		 #endif	
...
{
	#if (M10DEBUG)
	printf_string("prf_server_error_ind_send\n\r");
		 #endif	
...
{   
		#if (M10DEBUG)
	printf_string("prf_server_send_event\n\r");
			#endif
...
{   
	#if (M10DEBUG)
	printf_string("prf_cleanup_func\n\r");
		 #endif	   	  
//	   printf_string("conidx:\n\r");
//	   printf_byte(conidx);
//	   
//	   printf_string("conhdl:\n\r");
//	   print_hword(conhdl);
//	   printf_string("reason:\n\r");
//	   printf_byte(reason);
